...
int main(int argc, char *argv[])
{
    ...
    if (errors) {
        fprintf(stderr, "incPatch: usage: -l includeDir [<fileList] [files ...]\n");
        exit(2);
    }
...
static int patch(char *inputPath)
{
    ...
    while (fgets(buf, sizeof(buf), ifp)) {
        ...
        /*
         *  Skip till we see Local variables:
    tab-width: 4
    c-basic-offset: 4
    End:
